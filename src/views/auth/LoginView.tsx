...
export default function LoginView() {
  ...
  return (
    <>
      ...
      <p className="text-2xl font-light text-white mt-5">Administra tus propios {''}
      ...
      >
        ...
        <InputSubmit value={['Iniciar Sesión', 'Iniciando Sesión...']} isPending={isPending} color='purple'/>
      </form>
